...
const HIDDEN_GEMS = [
  { name: "Rashid's Cafeteria",       category: "☕ Café",            area: "Muharraq",        desc: "No-frills neighbourhood spot beloved by locals for decades. Proper karak chai and fresh samboosa.", why: "The cardamom ratio is unmatched — regulars say nowhere else in Bahrain gets it right.", bestTime: "6–9 AM or 4 PM tea rush", vibe: "🧡 Local legend" },
  { name: "Al Jasra Handicraft",      category: "🛍️ Shop",            area: "Al Jasra",        desc: "Living heritage workshop where artisans weave baskets, pottery and dhow models — buy direct from makers.", why: "One of the few places where traditional crafts are still practiced authentically.", bestTime: "Weekday mornings", vibe: "🎨 Authentic craft" },
  { name: "Dar Kulaib Beach",         category: "🏖️ Beach",           area: "North Bahrain",   desc: "Quiet, uncrowded beach away from resort crowds. Crystal clear water and stunning Gulf sunsets.", why: "While tourists go to resort beaches, locals come here. Practically deserted on weekdays.", bestTime: "Late afternoon — best sunset in Bahrain", vibe: "🌅 Sunset paradise" },
  { name: "Bu Maher Fort",            category: "🏰 Hidden Heritage", area: "Muharraq",        desc: "Rarely-visited Ottoman-era fort at the tip of Muharraq island — sea on three sides.", why: "No gift shop, no crowds, just raw history and panoramic Gulf views.", bestTime: "Sunset — light on old stone is extraordinary", vibe: "🗺️ Explorer's find" },
  { name: "Adliya Art District",      category: "☕ Café",            area: "Adliya",          desc: "Independent coffee shops and galleries in converted Bahraini houses. Specialty coffee, local art.", why: "Bahrain's creative heartbeat — beloved by the local arts scene.", bestTime: "Evenings when galleries open", vibe: "🎭 Creative hub" },
  { name: "Tubli Bay Mangroves",      category: "🌿 Nature",          area: "Tubli",           desc: "Bahrain's only mangrove forest — kayak through a quiet ecological wonder home to migratory birds.", why: "Almost no tourists know it exists. Wild nature minutes from the capital.", bestTime: "Early morning for birds and calm water", vibe: "🦅 Ecological secret" },
  { name: "Friday Market",            category: "🛍️ Shop",            area: "Sitra",           desc: "Weekly market where Bahrainis sell antiques, plants, spices and treasures. Totally unpolished and real.", why: "Where Bahrainis actually shop — not the tourist souk. Bargaining expected.", bestTime: "Friday 6–10 AM before the heat", vibe: "🏺 Raw & real" },
  { name: "Old Textile Souk",         category: "🛍️ Shop",            area: "Old Manama",      desc: "Hidden behind Bab Al Bahrain — fabrics, abayas, thobes and overnight tailoring at fraction of mall prices.", why: "Disappearing fast. Tailors here can make a custom thobe overnight — a dying skill.", bestTime: "Morning, avoid Fridays", vibe: "⏳ Vanishing tradition" },
  { name: "Janabiya Farm Trail",      category: "🌿 Nature",          area: "Janabiya",        desc: "Peaceful walking trail through date palm groves and traditional Bahraini farms. The air smells of earth and greenery.", why: "Most visitors never leave the capital. This 30-minute drive reveals Bahrain's agricultural soul, hidden in plain sight.", bestTime: "Early morning in cooler months (Nov–Mar)", vibe: "🌴 Off the beaten path" },
  { name: "Arad Bay Waterfront",      category: "🚶 Leisure",         area: "Muharraq",        desc: "Breezy seaside promenade lined with palm trees facing Arad Fort. Far less crowded than Manama Corniche with better views.", why: "Locals' favourite evening walk — families, joggers, fishermen, but almost no tourists.", bestTime: "After 6 PM when the heat breaks and the fort lights up", vibe: "🌊 Local favourite" },
  { name: "Al Bandar Beach",          category: "🏖️ Beach",           area: "Sakhir",          desc: "Calm, shallow beach popular with Bahraini families. Incredibly warm and clear water with a long sandy shore.", why: "Families bring their kids here — the shallow water extends far out, safe and ideal for a genuine local beach day.", bestTime: "Weekday mornings for a quiet visit", vibe: "👨‍👩‍👧 Family favourite" },
  { name: "Halwa House",              category: "☕ Café",            area: "Manama",          desc: "Heritage sweet shop serving traditional Bahraini halwa — dense, fragrant and made fresh daily using age-old recipes.", why: "Halwa is Bahrain's most iconic sweet and this is where locals buy it for weddings and celebrations.", bestTime: "Any time — always fresh, always perfect", vibe: "🍯 Taste of history" },
];
      ...
      {filtered.map((gem, i) => {
        ...
        return (
          <div key={i} style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 16, overflow: "hidden" }}>
            <div style={{ height: 130, background: grad, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
              <div style={{ fontSize: 50, filter: "drop-shadow(0 2px 10px rgba(0,0,0,0.5))" }}>{ic}</div>
              <div style={{ position: "absolute", top: 10, left: 10, background: "rgba(8,9,15,0.8)", borderRadius: 20, padding: "4px 10px", fontSize: 11, color: T.gold, fontFamily: "sans-serif" }}>{gem.category}</div>
              <div style={{ position: "absolute", top: 10, right: 10, background: "rgba(8,9,15,0.8)", borderRadius: 20, padding: "4px 10px", fontSize: 11, color: T.sub, fontFamily: "sans-serif" }}>📍 {gem.area}</div>
            </div>
